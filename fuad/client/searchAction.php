<?php
    ...
    if(!isset($_SESSION['index_login_email']) || !isset($_POST['searchbtn']))
    {
...
<html>
    <head>
        <title>Home</title>
		<link rel="stylesheet" type="text/css" href="searchAction.css" media="all" />
    </head>
    <body>
                            ...
                            <tr>
                                ...
                                <table border='1' name='booklist'>
                                        <?php
                                            ...
                                            $sql = "select * from book_ad where bookname='$name' order by id desc";
