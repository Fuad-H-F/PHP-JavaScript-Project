        ...
        <tr>
            ...
            <td>
                <form action="forumHandler.php" method="post">
                    <table>
                        <tr>
                            <td><h1>BOOK TITLE 2</h1></td>
                            <td><input type="submit" name="leaveForum" value="Leave Forum"></td>
                            <form action="">
                                <td><input type="submit" name="reportForum2" value="Report Forum"></td>
                            </form>
                        </tr>
                        <tr>
                    ...
                    <table>
                        <tr>
                            <td><b>User Name</b><hr></td>
                        </tr>
                        <tr>
                            <td>
                                <p>Specifies the height of the textarea based on the number of visible lines of text. If there's more text than this allows, users can scroll using the textarea's scrollbars.</p>
                            <hr>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>
                                <b>Your Comment<br><b>
                                <textarea row="10" col="50"></textarea>
                            </td>
                        </tr>
                        <tr>
