    ...
    <table width="99%" border="1">
        <tr>
            ...
            <table>
                    ...
                    <hr>
                    <hr>
                    <form action="<?="commentSaveController.php?id=".$id?>" method = "post">
                    <table>
                        <tr>
                            <td>
                                <b>Your Comment<br><b>
                                <textarea row="10" col="50" name='save'></textarea>
                            </td>
                        </tr>
                        <tr>
                ...
                <table>
                <?php
                    $sql = "select * from forum_comment where forum_id = $id";
                    $res = get_result($sql);
                    while($row = mysqli_fetch_assoc($res))
                    {
                        $email = $row['commentator_email'];
                        $sql2 = "select name from user_login where email = '$email'";
