        ...
        <tr>
            ...
            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <form action="forumBookReqList.php?id=<?=$id?>" method="post">
                                                <input type="submit" value="View Request" name="viewReq">
                                            </form>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <table>
                        <tr>
                            <td>
                                <form action=<?="'editForumBook1.php?id=".$id."'"?> method="post">
                                    <input type="submit" name="editFor1" value="Edit Forum">
                                </form>
                            </td>
